...
function getAddEthereumChainParam(chain, chainIdHex) {
	...
	if (chain === defaultPolygonChainValue && environment === "staging") addEthereumChainParam = addEthereumChainParams.mumbai;
	if (chain === defaultTelosChainValue && environment === "production") addEthereumChainParam = addEthereumChainParams.telos;
	if (chain === defaultTelosChainValue && environment === "staging") addEthereumChainParam = addEthereumChainParams.telosTesnet;
